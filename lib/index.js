...
const JSONLZ4Parser = require(path.resolve(
  __dirname,
  './bookmark_parser/jsonlz4_parser'
));
const HTMLParser = require(path.resolve(
  __dirname,
  './bookmark_parser/html_parser'
));

module.exports.readFromHTMLReadStream = module.exports.readFromHTMLFile = (
  source,
  dest
) => {
  ...
  switch (os.type()) {
    case 'Darwin':
      ...
      return fs
        ...
        .then(
          dir => (filePath = path.join(filePath, dir[0], 'bookmarkbackups'))
        )
